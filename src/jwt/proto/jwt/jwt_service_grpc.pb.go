...
const (
	JwtService_GenerateToken_FullMethodName = "/JwtService/GenerateToken"
)
...
func (c *jwtServiceClient) GenerateToken(ctx context.Context, in *GenerateTokenRequest, opts ...grpc.CallOption) (*GenerateTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, JwtService_GenerateToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var JwtService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/jwt_service.proto",
}
